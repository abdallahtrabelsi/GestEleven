  ...
  <div class="card-header">
    <h3>
      <?php
                    ...
                    ?>
     Profile <span class="float-right"> <a href="index.php" class="btn btn-primary">Back</a> </h3>
  </div>
  <div class="card-body">
      ...
      <div style="width:600px; margin:0px auto">
        ...
        <form class="" action="" method="POST">
          ...
          <?php if (Session::get("roleid") == '1') { ?>
            ...
            <!-- ******************Team user  *************************-->
            <!-- <div class="form-group">
              <label for="name_tm">Select Teams</label>
              <select class="form-control" name="name_tm" id="name_tm"> -->
...
<?php
// <!-- ************************************ -->
          // if (Session::get("id") == $getUinfo->id) { 
            ?>


            <div class=" form-group">
            <!-- <button type="submit" name="update" class="btn btn-success">Update</button> -->
            <!-- <a class="btn btn-primary" href="changepass.php?id=
            <?php 
            // echo $getUinfo->id; 
            ?>
            ">Password change</a> -->
